...
class Sheet3(models.Model):
    ...
    biz_category = models.CharField(max_length=255, blank=True, null=True)
    individual_tax_rate = models.CharField(max_length=255, blank=True, null=True)
    tax_rate_calculation_method = models.CharField(max_length=255, blank=True, null=True)
    buy_service_charge_rate = models.CharField(max_length=255, blank=True, null=True)
    buy_vat_rate = models.CharField(max_length=255, blank=True, null=True)
    buy_service_fee_isnot_vat = models.CharField(max_length=255, blank=True, null=True)
    buy_algorithm = models.CharField(max_length=255, blank=True, null=True)
    sale_vendor = models.CharField(max_length=255, blank=True, null=True)
    sale_channel = models.CharField(max_length=255, blank=True, null=True)
    sale_contract_config = models.CharField(max_length=255, blank=True, null=True)
    sale_invitation_code = models.CharField(max_length=255, blank=True, null=True)
    sale_issue_attribute = models.CharField(max_length=255, blank=True, null=True)
    sale_manage_fee_rate = models.CharField(max_length=255, blank=True, null=True)
    sale_vat_rate = models.CharField(max_length=255, blank=True, null=True)
    sale_algorithm = models.CharField(max_length=255, blank=True, null=True)
    sale_manage_fee_isnot_vat = models.CharField(max_length=255, blank=True, null=True)
    sale_manage_fee_isnot_tax = models.CharField(max_length=255, blank=True, null=True)
    sale_entry_name = models.CharField(max_length=255, blank=True, null=True)
    sale_money_attribute = models.CharField(max_length=255, blank=True, null=True)
    extend_promotion_fee_rate = models.CharField(max_length=255, blank=True, null=True)
    extend_vat_rate = models.CharField(max_length=255, blank=True, null=True)
    extend_algorithm = models.CharField(max_length=255, blank=True, null=True)
    extend_promotion_fee_isnot_vat = models.CharField(max_length=255, blank=True, null=True)
    extend_billing_start_time = models.CharField(max_length=255, blank=True, null=True)
    extend_billing_cycle_length = models.CharField(max_length=255, blank=True, null=True)
    extend_threshold_rate = models.CharField(max_length=255, blank=True, null=True)
    sale_task_type = models.CharField(max_length=255, blank=True, null=True)
    extend_intermediary_fee_rate = models.CharField(max_length=255, blank=True, null=True)
    extend_intermediary_fee_includes_vat = models.CharField(max_length=255, blank=True, null=True)
    outsource_manage_fee_rate = models.CharField(max_length=255, blank=True, null=True)
    outsource_vat_rate = models.CharField(max_length=255, blank=True, null=True)
    outsource_algorithm = models.CharField(max_length=255, blank=True, null=True)
    outsource_manage_fee_isnot_vat = models.CharField(max_length=255, blank=True, null=True)
    settlement_method = models.CharField(max_length=255, blank=True, null=True)
    contract_id = models.CharField(max_length=255, blank=True, null=True)
    product_setting = models.CharField(max_length=255, blank=True, null=True)
...
class Contract(models.Model):
    id = models.BigAutoField(primary_key=True)
    biz_number = models.CharField(unique=True, max_length=30)
...
class Invoice(models.Model):
    ...
    invoice_category = models.CharField(max_length=20)
...
class ProductData(models.Model):
    ...
    extend_billing_cycle_length = models.IntegerField(blank=True, null=True)
