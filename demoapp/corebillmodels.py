...
class InvoiceOrderDetail(models.Model):
    ...
    invoice_order_detail_number = models.CharField(unique=True, max_length=50)
...
class OrderBatch(models.Model):
    ...
    apply_task_name = models.CharField(max_length=255, blank=True, null=True)
    ...
    work_key = models.CharField(max_length=512, blank=True, null=True)
...
class OrderInfo(models.Model):
    ...
    platform_fee_rate = models.DecimalField(max_digits=20, decimal_places=6, blank=True, null=True)
    ...
    invoice_apply_time = models.DateTimeField(blank=True, null=True)
    invoice_apply_username = models.CharField(max_length=255, blank=True, null=True)
