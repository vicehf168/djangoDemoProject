...
class CtUserRegister(models.Model):
    ...
    register_mode = models.CharField(max_length=64, blank=True, null=True)
    mobile_phone = models.CharField(max_length=64, blank=True, null=True)
    face_pic = models.CharField(max_length=4096, blank=True, null=True)
    is_deleted = models.SmallIntegerField()
    ...
    class Meta:
        ...
        unique_together = (('company_user_identification', 'register_mode', 'is_deleted'),)
        app_label = 'demoapp'
...
class Feedback(models.Model):
    ...
    imgs = models.CharField(max_length=1000, blank=True, null=True)
...
class LaborUserBank(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('user_id', 'is_delete'),)
        app_label = 'demoapp'
...
class ThirdPartyUserRegister(models.Model):
    id = models.BigAutoField(primary_key=True)
    third_union_key = models.CharField(max_length=255, blank=True, null=True)
    user_id = models.BigIntegerField(blank=True, null=True)
    corp_id = models.CharField(max_length=32, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'third_party_user_register'
        unique_together = (('third_union_key', 'corp_id'),)
        app_label = 'demoapp'
